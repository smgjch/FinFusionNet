...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.conv1_layers = nn.Conv2d(in_channels=1, out_channels= self.num_filters, kernel_size=4, stride=1)
        self.conv2_layers = nn.Conv2d(in_channels=self.num_filters, out_channels= 3, kernel_size=2, stride=1)
        self.conv3_layers = nn.Conv2d(in_channels=4, out_channels= 2, kernel_size=2, stride=1)
