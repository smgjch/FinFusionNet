...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.conv1_layers = nn.Conv2d(in_channels=1, out_channels= self.num_filters, kernel_size=2, stride=1)

        
        input_size = int((self.enc_in-1)*(self.input_window_size-1)*self.num_filters)
