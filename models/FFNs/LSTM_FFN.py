...
class Model(nn.Module):
    ...
    def patch_conv(self, inputs, window_size=30, stride=5):
        ...
        for i in range(0, x - window_size, stride):
            ...
            # sampled = self.projection2(sampled)
            # sampled = self.projection3(sampled)
            # sampled = F.tanh(self.projection4(sampled))
            # sampled = F.tanh(self.projection5(sampled))
